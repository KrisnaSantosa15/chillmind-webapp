      ...
      <main className="flex flex-col min-h-screen pt-20">
        ...
        <section className="relative py-20 px-6 md:px-12 bg-gradient-to-br from-indigo-500/10 via-purple-500/5 to-pink-500/10">
          ...
          <div className="relative max-w-4xl mx-auto text-center">
            ...
            >
              Our solemn promise to protect, respect, and empower you through
              ethical data practices in mental health care.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10  rounded-xl p-8">
                ...
                <div className="space-y-6">
                  <div className="text-lg text-muted-foreground leading-relaxed">
                    <p className="mb-4">
                      At ChillMind, we understand that mental health data is
                      among the most sensitive and personal information you can
                      share. We don&apos;t take this responsibility lightly.
                    </p>
                    <p>
                      This Data Commitment goes beyond legal
                      compliance—it&apos;s our ethical pledge to treat your
                      mental health journey with the respect, protection, and
                      care it deserves.
                    </p>
                  </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-6 mt-8">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Military-grade encryption and zero-knowledge
                        architecture
                      </p>
                    </div>
                    <div className="text-center">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Clear, honest communication about data use
                      </p>
                    </div>
                    <div className="text-center">
                  ...
                  <div className="space-y-6">
                    <div className="border-l-4 border-indigo-500 pl-6">
                      ...
                      <p className="text-muted-foreground">
                        We only collect and use data for mental health
                        monitoring and improvement—never for advertising,
                        profiling, or commercial exploitation.
                      </p>
                    </div>
                    <div className="border-l-4 border-purple-500 pl-6">
                      ...
                      <p className="text-muted-foreground">
                        ...
                        personalized mental health insights and support.
                      </p>
                    </div>
                    <div className="border-l-4 border-blue-500 pl-6">
                      ...
                      <p className="text-muted-foreground">
                        Every piece of data collection requires your explicit,
                        informed consent. You can withdraw consent at any time.
                      </p>
                    </div>
                  </div>
                  <div className="space-y-6">
                    <div className="border-l-4 border-pink-500 pl-6">
                      ...
                      <p className="text-muted-foreground">
                        You own your data. You can view, export, correct, or
                        delete it at any time without losing access to our
                        services.
                      </p>
                    </div>
                    <div className="border-l-4 border-indigo-400 pl-6">
                      ...
                      <p className="text-muted-foreground">
                        Our AI models are trained ethically, with bias detection
                        and human oversight to ensure fair and beneficial
                        outcomes.
                      </p>
                    </div>
                    <div className="border-l-4 border-purple-400 pl-6">
                      ...
                      <p className="text-muted-foreground">
                        ...
                        Your mental health information is not a commodity.
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            AES-256 encryption from your device to our servers
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            We can&apos;t access your raw emotional data
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            ISO 27001 certified data centers with 24/7
                            monitoring
                          </p>
                        </div>
                      </div>
                  ...
                  <div>
                    ...
                    <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-lg p-6">
                      <ul className="space-y-3 text-sm text-muted-foreground">
                        ...
                        <li className="flex items-center">
                          <div className="w-2 h-2 bg-indigo-500 rounded-full mr-3"></div>
                          Employee background checks and confidentiality
                          agreements
                        </li>
                        <li className="flex items-center">
                          <div className="w-2 h-2 bg-indigo-500 rounded-full mr-3"></div>
              ...
              <div className="bg-background border border-muted rounded-xl p-8">
                ...
                <div className="space-y-6">
                  <p className="text-muted-foreground leading-relaxed">
                    We believe the best data protection is not collecting
                    unnecessary data in the first place. Our platform is
                    designed to provide maximum benefit with minimum data.
                  </p>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="bg-indigo-500/10 rounded-lg p-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Monitor exactly what data we have and how it&apos;s
                      ...
                      <div className="bg-purple-500/10 rounded-lg p-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Regular updates on our data practices, security
                      ...
                      <div className="bg-blue-500/10 rounded-lg p-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Key privacy and security components of our code are
            ...
            >
              ...
              <p className="text-muted-foreground mb-6">
                Have questions about our data practices? Want to exercise your
