      ...
      <main className="flex flex-col min-h-screen pt-20">
        ...
        <section className="relative py-20 px-6 md:px-12 bg-gradient-to-br from-indigo-500/10 via-purple-500/5 to-pink-500/10">
          ...
          <div className="relative max-w-4xl mx-auto text-center">
            ...
            >
              Clear, fair terms that protect both you and ChillMind while
              ensuring the best possible mental health support.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 rounded-xl p-8">
                ...
                <div className="space-y-6 text-muted-foreground">
                  <p className="text-lg leading-relaxed">
                    ...
                    of ChillMind, a mental health monitoring platform designed
                    specifically for students. By using our services, you agree
                    to these terms.
                  </p>
                  <div className="bg-indigo-600/10 border border-indigo-600/20 rounded-lg p-6">
                    ...
                    <p className="text-sm">
                      ChillMind provides mental health monitoring tools and is
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-lg font-semibold text-foreground mb-4">
                      By Using ChillMind, You Agree To:
                    </h3>
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start">
                        <div className="w-3 h-3 bg-green-500 rounded-full mr-3 mt-2"></div>
                        <span className="text-muted-foreground">
                          Respect other users privacy and wellbeing
                        </span>
                      </div>
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="bg-muted/50 rounded-lg p-4">
                      <p className="text-sm text-muted-foreground mb-3">
                        You must be at least 13 years old to use ChillMind. If
                        you&apos;re under 13, you need parental consent.
                      </p>
                      <p className="text-sm text-muted-foreground">
                        Our services are primarily designed for students in
              ...
              <div className="bg-background border border-muted rounded-xl p-8">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="border border-muted rounded-lg p-6">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Daily mood logging and pattern analysis to help you
                      understand your mental health trends.
                    </p>
                  </div>
                  <div className="border border-muted rounded-lg p-6">
                    ...
                    <p className="text-sm text-muted-foreground">
                      AI-powered recommendations and insights based on your
                  ...
                  <div className="border border-muted rounded-lg p-6">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Anonymous peer support and wellness challenges within our
                      student community.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-sm text-muted-foreground">
                        ...
                        <li>
                          • Report technical issues that affect data quality
                        </li>
                        <li>
                          • Use the platform consistently for best results
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div className="bg-orange-500/10 border border-orange-500/20 rounded-lg p-6">
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      contact emergency services, a crisis hotline, or seek
                      immediate professional help. ChillMind cannot provide
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
                      <p className="text-sm text-muted-foreground mb-3">
                        ChillMind is a supportive community. We strictly
                        prohibit:
                      </p>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="border border-muted rounded-lg p-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                          At any time, for any reason, with immediate effect.
                        </p>
                      </div>
                      <div className="border border-muted rounded-lg p-4">
                        <h4 className="font-medium text-foreground mb-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Download all your personal data before account
                          deletion.
                        </p>
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-xs text-muted-foreground">
                        We&apos;ll provide 30 days notice when possible, except
            ...
            >
              ...
              <p className="text-muted-foreground mb-6">
                Our Legal Team is here to help clarify any aspect of our Terms
                of Service.
              </p>
