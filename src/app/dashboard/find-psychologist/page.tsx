...
export default function FindPsychologistPage() {
      ...
      try {
        ...
        if (result && result.psychologists && result.psychologists.length > 0) {
          ...
          if (selectedCities.length > 0) {
            setErrorMessage(
              "Could not find psychologists in the selected location. Showing sample data instead."
            );
          }
        }
      } catch (error) {
        ...
        setErrorMessage(
          "There was an issue connecting to the psychologist database. Showing sample data for now."
        );
      } finally {
        setIsLoading(false);
      }
  ...
  useEffect(() => {
    const filtered = psychologists.filter((psychologist) => {
      ...
      const matchesPriceRange =
        !selectedPriceRange ||
        checkPriceRange(psychologist.price, selectedPriceRange);
  ...
  const getAllAssociations = () => {
    ...
    psychologists.forEach((p) =>
      p.association.forEach((s) => associations.add(s))
    );
  ...
  const PsychologistCard = ({
    ...
    <div className="bg-background p-4 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-muted">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between">
            <div className="mb-2 sm:mb-0">
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                <span
                  className={`sm:hidden self-start px-3 py-1 rounded-full text-sm font-medium ${
              ...
              <div className="flex flex-wrap items-center gap-x-2 gap-y-1 mt-2">
                ...
                {psychologist.registrationId && (
                  <span className="text-sm text-muted-foreground">
                    • No. {psychologist.registrationId}
                  </span>
                )}
              </div>
            </div>{" "}
            <span
              className={`hidden sm:inline-block px-3 py-1 rounded-full text-sm font-medium shrink-0 ${
                psychologist.available
                  ? "bg-green-300 dark:bg-green-900/30 text-green-700"
                  : "bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300"
              }`}
              ...
              {psychologist.contactNumber && (
                <a
                  href={`${
                    ...
                    psychologist.name
                  )},%20I%20found%20your%20profile%20on%20ChillMind%20and%20would%20like%20to%20inquire%20about%20your%20services.`}
                  target="_blank"
  ...
  return (
    <div className="min-h-screen bg-background bg-gradient-to-br from-background via-background/70 to-background">
      {/* Header */}{" "}
      <div className="bg-background shadow-sm border-b border-muted">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm sm:text-base mt-1 sm:mt-2">
                Connect with HIMPSI registered psychologists near you
              </p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {" "}
        <div className="bg-background rounded-xl shadow-lg border border-muted/50 p-4 sm:p-6 mb-8">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div className="flex flex-wrap items-center gap-2">
                <p className="text-sm text-muted-foreground">
                  Found {filteredPsychologists.length} psychologist
        ...
        {isLoading ? (
                    ...
                    <div className="mt-8 flex justify-center">
                      <nav className="flex items-center justify-center gap-2">
                        ...
                        <button
                          onClick={() =>
                            setCurrentPage((curr) =>
                              Math.min(pagination.totalPages, curr + 1)
                            )
                          }
          ...
          <div
            className="bg-background rounded-xl shadow-lg overflow-hidden animate-fadeIn transition-all"
            style={{ height: "600px" }}
          >
      ...
      {/* Detailed Modal */}
      {showModal && selectedPsychologist && (
              ...
              <div className="flex flex-col items-center mb-6 pt-4">
                ...
                <div className="text-center w-full">
                  ...
                  <div className="flex items-center justify-center gap-2 mt-2">
                    ...
                    <span className="text-sm text-muted-foreground">
                      ({selectedPsychologist.rating.toFixed(1)})
                    </span>
                  </div>
              ...
              <div className="space-y-6 mt-4">
                <div className="border-t border-border pt-4">
                  ...
                  <p className="text-muted-foreground bg-muted/50 p-3 rounded-lg">
                    {selectedPsychologist.description}
                  </p>
                </div>{" "}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedPsychologist.association
                      .slice(0, 1)
                      .map((spec, index) => (
                        <span
                          key={index}
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    {selectedPsychologist.sessionTypes.join(", ")}
                  </p>
                </div>
                  ...
                  <div className="bg-muted/50 px-4 py-3 rounded-lg w-full sm:w-auto">
                    <p className="text-lg font-semibold text-foreground flex items-end gap-1 justify-center sm:justify-start">
                      ...
                      <span className="text-sm font-normal text-muted-foreground">
                        /session
                        {selectedPsychologist.isPriceEstimated
                          ? " (estimated)"
                          : ""}
                      </span>
                    </p>
                    <div className="flex items-center mt-1 text-sm text-muted-foreground justify-center sm:justify-start">
                      ...
                      <span>
                        {selectedPsychologist.experience} years experience
                      </span>
                    </div>
                  </div>{" "}
