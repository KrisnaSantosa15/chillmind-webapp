...
import { Phone, MessageSquare, Globe, Heart, Clock, Users, MapPin, Star, ChevronDown } from 'lucide-react';
...
export default function CrisisResources() {
  ...
  const categories = [
    ...
    { id: 'specialty', name: 'Specialized Support', icon: Users, color: 'green' }
  ];

  const emergencyResources: Record<string, Array<{
    name: string;
    number: string;
    description: string;
    available: string;
    ...
    us: [
      {
        ...
        number: "988",
        description: "Free, confidential crisis support for people in distress and prevention resources",
        available: "24/7",
        type: "suicide",
    ...
    uk: [
      {
        name: "Samaritans",
        number: "116 123",
        description: "Free emotional support for anyone in emotional distress or struggling to cope",
        available: "24/7",
        type: "suicide",
      ...
      },
      {
        name: "NHS 111",
        number: "111",
        description: "Free medical help and advice when it's not a 999 emergency",
        available: "24/7",
        type: "emergency"
      },
      {
    ...
    ],    indonesia: [
      {
        ...
        description: "Platform konseling online dengan psikolog profesional untuk ibu dan keluarga",
        available: "24/7",
        type: "specialty",
      ...
      },
      {
        ...
        description: "Ikatan Psikolog Klinis Indonesia - direktori psikolog dan layanan konseling",
        available: "Jam kerja",
        type: "suicide",
  ...
  const filteredResources = emergencyResources[activeRegion]?.filter(resource => 
      ...
      <main className="flex flex-col min-h-screen pt-20">
        {/* Hero Section */}        <section className="relative py-20 px-6 md:px-12 bg-gradient-to-br from-indigo-500/10 via-purple-500/5 to-pink-500/10">
          ...
          <div className="relative max-w-4xl mx-auto text-center">
            ...
            >
              Immediate help is available. You are not alone, and your life has value. Reach out for support when you need it most.
            </motion.p>
              {/* Emergency Banner */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <p className="text-indigo-100 mb-4">If you are in immediate danger or thinking of harming yourself, please call emergency services right away.</p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <a href="tel:112" className="bg-white text-indigo-600 px-6 py-3 rounded-lg font-bold hover:bg-indigo-50 transition-colors">
                  Call 112 (International Emergency)
                </a>
                <a href="tel:119" className="bg-indigo-500 text-white px-6 py-3 rounded-lg font-bold hover:bg-indigo-400 transition-colors">
        ...
        <section className="sticky top-20 bg-background/95 backdrop-blur-sm border-b border-muted z-10">
          <div className="max-w-6xl mx-auto px-6 md:px-12">
            <div className="flex flex-col sm:flex-row items-center justify-between py-4 gap-4">
              <h2 className="text-lg font-semibold text-foreground">Select Your Region:</h2>
              ...
              <div className="sm:hidden w-full">
                <div className="relative">
                  ...
                  >
                    ...
                    <ChevronDown className={`h-4 w-4 transition-transform ${regionMenuOpen ? 'rotate-180' : ''}`} />
                  </button>
                  {regionMenuOpen && (
          ...
          <div className="max-w-6xl mx-auto">
            {filteredResources.length > 0 ? (
                ...
                {filteredResources.map((resource, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <h3 className="text-lg font-bold text-foreground flex-1">{resource.name}</h3>
                      {resource.type === 'emergency' && <Phone className="h-5 w-5 text-red-500 flex-shrink-0 ml-2" />}
                      {resource.type === 'suicide' && <Heart className="h-5 w-5 text-purple-500 flex-shrink-0 ml-2" />}
                      {resource.type === 'chat' && <MessageSquare className="h-5 w-5 text-blue-500 flex-shrink-0 ml-2" />}
                      {resource.type === 'specialty' && <Users className="h-5 w-5 text-green-500 flex-shrink-0 ml-2" />}
                    </div>
                    
                    <div className="space-y-3">
                      <div className="flex items-center">
                        <Phone className="h-4 w-4 text-muted-foreground mr-2" />
                        <span className="font-mono text-lg text-foreground">{resource.number}</span>
                      </div>
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">Resources Coming Soon</h3>
                <p className="text-muted-foreground">We&apos;re working to add more resources for this region and category.</p>
              </div>
            )}
            ...
            <motion.section
              ...
              className="mt-16"
            >
              <h2 className="text-2xl font-bold text-foreground mb-8 text-center">Additional Support & Self-Care</h2>
                ...
                <div className="bg-gradient-to-br from-indigo-500/10 to-indigo-800/10 rounded-xl p-6">
                  ...
                  <p className="text-sm text-muted-foreground">Try the 4-7-8 technique: breathe in for 4, hold for 7, exhale for 8.</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-purple-500/10 to-purple-800/10 rounded-xl p-6">
                  ...
                  <h3 className="font-semibold text-foreground mb-2">Reach Out</h3>
                  <p className="text-sm text-muted-foreground">Contact a trusted friend, family member, or counselor.</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-blue-500/10 to-blue-800/10 rounded-xl p-6">
                  ...
                  <h3 className="font-semibold text-foreground mb-2">Grounding Technique</h3>
                  <p className="text-sm text-muted-foreground">Name 5 things you see, 4 you can touch, 3 you hear, 2 you smell, 1 you taste.</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-pink-500/10 to-pink-800/10 rounded-xl p-6">
                  ...
                  <h3 className="font-semibold text-foreground mb-2">This Too Shall Pass</h3>
                  <p className="text-sm text-muted-foreground">Remember that intense feelings are temporary and will subside.</p>
                </div>
              </div>
            </motion.section>
            ...
            >
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  <strong>ChillMind is not a crisis intervention service.</strong> While we provide mental health monitoring tools, we cannot provide emergency assistance or immediate intervention.
                </p>
                <p>
                  If you are in immediate danger or experiencing thoughts of self-harm, please contact local emergency services or a crisis hotline immediately.
                </p>
                <p>
                  The resources listed here are provided for informational purposes. Please verify current contact information and availability as these may change.
                </p>
              </div>
            </motion.section>
            ...
            >
              <h2 className="text-2xl font-bold text-foreground mb-4">Need to Add a Resource?</h2>
              <p className="text-muted-foreground mb-6">
                Help us improve this page by suggesting additional crisis resources for your region.
              </p>
