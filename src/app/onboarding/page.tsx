        ...
        <div className="max-w-3xl mx-auto">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Let&apos;s start with a quick assessment to understand your
              current mental state. This will help us personalize your
              experience.
            </p>
          </div>
          ...
          <div className="bg-background border border-muted rounded-lg p-8 shadow-sm">
            ...
            <p className="text-muted-foreground mb-8">
              We&apos;ll ask you questions based on clinically validated
              assessments:
            </p>
            ...
            <p className="text-sm text-muted-foreground mb-8">
              Your responses are private and secure. They help us provide
              personalized insights and recommendations. This assessment takes
