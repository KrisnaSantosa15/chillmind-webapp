    ...
    const fetchRecommendations = async () => {
      ...
      try {
        ...
        const getRecommendation = (
          ...
          try {
            const conditionData = recommendationsData[condition] as Record<
              string,
              RecommendationItem[]
            >;
            ...
            console.error(
              `Error getting ${condition} recommendation for level ${level}:`,
              error
            );
          }
          return null;
        ...
        const stressData = recommendationsData.stress as Record<
          string,
          RecommendationItem[]
        >;
      ...
      <div className="divide-y divide-muted">
        ...
        {isLoading ? (
          ...
          <div className="p-4 flex flex-col items-center justify-center py-8 text-center">
            <div
              className={`w-16 h-16 rounded-full bg-primary-light/20 text-primary flex items-center justify-center mb-4`}
            >
            ...
            <p className="text-xs text-muted-foreground mb-3 max-w-xs">
              Complete a mental health assessment to get personalized
              recommendations based on your needs.
            </p>
            <Link
              href="/dashboard/resources"
              className="text-xs font-medium text-primary hover:text-primary/80 inline-flex items-center"
            >
