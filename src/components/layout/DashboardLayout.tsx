...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      ></div>
      <div
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-background border-r border-muted transform transition-transform md:translate-x-0 md:relative ${
        ...
        <div className="flex flex-col h-full w-64">
          ...
          <div className="flex flex-col flex-grow px-4 py-4 overflow-y-auto">
            <nav className="space-y-1">
              ...
              >
                <i
                  className={`fas fa-robot h-5 w-5 mr-3 ${
                    isActive("/dashboard/ai-assistant")
                      ? "text-primary"
                      : "text-muted-foreground"
                  }`}
            ...
            <div className="mt-auto pt-6">
              <div className="p-4 bg-primary/10 rounded-lg">
                ...
                <button className="mt-3 w-full px-3 py-2 text-xs font-medium text-center text-white bg-primary rounded-md hover:bg-primary/90 transition-colors">
                  Emergency Contact
                </button>
              </div>
            </div>
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        {/* Top navigation */}
        <div className="flex items-center justify-between h-16 px-4 bg-background border-b border-muted">
          <div className="flex items-center">
            <button
